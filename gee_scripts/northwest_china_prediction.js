...
// 风机检测 - Northwest China 预测脚本
// 生成时间: 2026-02-18 22:52:23

// 定义区域边界
var region_bbox = ee.Geometry.Rectangle([75, 35, 100, 45]);

// 加载样本数据
var samples = ee.FeatureCollection('users/wuxuanyue051213/northwest_china_wind_samples');
...
print('=== NORTHWEST_CHINA EVALUATION ===');
