...
// 风机检测 - North China 预测脚本
// 生成时间: 2026-02-18 22:52:23

// 定义区域边界
var region_bbox = ee.Geometry.Rectangle([110, 35, 120, 45]);

// 加载样本数据
var samples = ee.FeatureCollection('users/wuxuanyue051213/north_china_wind_samples');
