...
// 风机检测 - East China 预测脚本
// 生成时间: 2026-02-18 22:52:23

// 定义区域边界
var region_bbox = ee.Geometry.Rectangle([115, 25, 125, 35]);

// 加载样本数据
var samples = ee.FeatureCollection('users/wuxuanyue051213/east_china_wind_samples');
